...
plugin_identifier = "go2rtc"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_go2rtc"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint go2rtc"
...
# module
plugin_description = """Plugin to control and configure go2rtc from within OctoPrint."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-go2rtc"
